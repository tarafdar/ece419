...
public abstract class Maze {
    ...
    public abstract void addClient(Client client, Point point, Direction d, int score);
    ...
    public abstract void killed(Client source, Client target, Point point, Direction d); 
    /** 
